...
Specific offerings may vary based on your location and app version. EveryHome does not provide these services directly but acts as an intermediary to facilitate connections.
...
When using EveryHome, you are responsible for:
  ...
  • Appropriate Use: Avoiding misuse of the platform, including fraudulent activities, spamming, or harassment of service providers.
...
EveryHome is a facilitator and does not guarantee the quality, accuracy, or timeliness of services provided by third-party service providers.
...
Termination of access does not absolve you of any outstanding financial obligations owed to service providers or EveryHome.

6. Intellectual Property
  • All content on EveryHome, including text, images, logos, and software, is owned by EveryHome and protected under copyright, trademark, and other intellectual property laws.
  • Unauthorized use, reproduction, or distribution of our intellectual property is strictly prohibited.

7. Governing Law
These Terms and Conditions are governed by the laws of Kerala, India. Any disputes arising from these terms will be resolved under the jurisdiction of the courts in Kerala.

8. Amendments
EveryHome reserves the right to update or modify these Terms and Conditions at any time. Changes will be communicated via the platform or email. Continued use of the platform after updates constitutes acceptance of the revised terms.

9. Contact Us
If you have any questions or concerns regarding these Terms and Conditions, please contact us at:
Email: sangi@tltechnologies.net
      `,
  },
  privacyPolicy: {
...
1. Information We Collect
  ...
  • Usage Data: Information about how you interact with our platform, including pages viewed, features used, and error reports to improve user experience.
  • Transaction Data: Details related to payments or purchases made through our platform.
...
Our website and app may use cookies to enhance user experience. You can manage cookie preferences through your browser settings.

7. Changes to This Policy
We may update this Privacy Policy from time to time. Changes will be communicated through our platform or via email.
